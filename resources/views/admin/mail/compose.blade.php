<x-admin-layout>
    <style>
        .select2-selection.is-invalid {
            ...
            /* Optional: Bootstrap's invalid icon */
        }
                                    ...
                                    <div class="mx-3">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="body" id="easyMdeEditor" rows="5" style="display: none;" required>{{ old('body') }}</textarea>
                                            </div>
                                        </div>
                                        <div>
    ...
    @push('scripts')
        <script>
            $('#composeEmail').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.message == 'Email saved in draft!') {
                            const draftCountElement = document.getElementById('draft-count');
                            if (draftCountElement) {
                                let currentCount = parseInt(draftCountElement.textContent);
                                currentCount = isNaN(currentCount) ? 0 : currentCount + 1;
            ...
            $('#group_id').on('change', function() {
                ...
                // Clear the contact select first
